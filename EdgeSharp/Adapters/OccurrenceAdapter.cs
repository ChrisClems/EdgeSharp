...
public class OccurrenceAdapter : IOccurrenceEsx
{
    ...
    public void PutTransform(double OriginX, double OriginY, double OriginZ, double AngleX, double AngleY,
        double AngleZ)
    {
        _occurrence.PutTransform(OriginX, OriginY, OriginZ, AngleX, AngleY, AngleZ);
    }

    public void GetTransform(out double OriginX, out double OriginY, out double OriginZ, out double AngleX,
        out double AngleY,
        out double AngleZ)
    {
    ...
    public void Rotate(double AxisX1, double AxisY1, double AxisZ1, double AxisX2, double AxisY2, double AxisZ2,
        double Angle)
    {
