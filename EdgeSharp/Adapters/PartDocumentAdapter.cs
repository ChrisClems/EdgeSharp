...
public class PartDocumentAdapter : IPartMetalDocument
{
    ...
    {
        _partDocument.PrintOut(Printer, NumCopies, Orientation, PaperSize, Scale, PrintToFile, OutputFileName, PrintRange, Sheets, ColorAsBlack, Collate);
    }
    ...
    {
        _partDocument.SaveAs(NewName, IsATemplate, FileFormat, ReadOnlyEnforced, ReadOnlyRecommended, NewStatus, CreateBackup, UpdateLinkInContainer, UpdateAllLinksInContainer);
    }
    ...
    {
        _partDocument.NormalDistance(Element1, Element2, out TrueDistance, out ApparentDistance, out DeltaX, out DeltaY, out DeltaZ, CoordinateSystem);
    }
    ...
    {
        _partDocument.GetUserPhysicalProperties(out Volume, out Area, out Mass, out CenterOfGravity, out CenterOfVolume, out GlobalMomentsOfInertia, out PrincipalMomentsOfInertia, out PrincipalAxes, out RadiiOfGyration);
    }
    ...
    {
        _partDocument.PutUserPhysicalProperties(ref Volume, ref Area, ref Mass, ref CenterOfGravity, ref CenterOfVolume, ref GlobalMomentsOfInertia, ref PrincipalMomentsOfInertia, ref PrincipalAxes, ref RadiiOfGyration);
    }
    ...
    public void GetCapturedRelationshipInformation(out Array RelationshipTypes, out Array OffsetTypes, out Array Offsets,
        out object Faces)
    {
        _partDocument.GetCapturedRelationshipInformation(out RelationshipTypes, out OffsetTypes, out Offsets, out Faces);
    }
    ...
    {
        _partDocument.GoalSeek(NameTargetVariable, NameVariableToChange, dTargetValue, dTimeLimitInSecs, NumIterationsLimit, out dTimeElapsed, out NumIterations, out TimeLimitExceeded, out IterationsLimitExceeded);
    }
    ...
    {
        _partDocument.MoveToSynchronous(pFeatureUnk, bIgnoreWarnings, bExtendSelection, out NumberOfFeaturesCausingError, out ErrorMessageArray, out NumberOfFeaturesCausingWarning, out WarningMessageArray, out VolumeDifference);
    }
    ...
    {
        _partDocument.TransformToSynchronousSheetmetal(pRefFace, nEdgeNum, ref EdgesArray, BRType, dBRWidth, dBRLength, dBendRadius, dNeutralFactor);
    }
    ...
    {
        _partDocument.GetMultiBodyPublishMembers(out NumMembers, out Members, out AssemblyExist, out AssemblyFileName, out AssemblyStatus);
    }
    ...
    {
        _partDocument.SaveMultiBodyPublishMembers(NumMembers, ref Members, CreateAssembly, FileName, out AssemblyStatus);
    }
    ...
    public void GetRayIntersections(ref Array Bodies, ref Array Origins, ref Array Directions, int NumRays, double Radius,
    ...
    {
        _partDocument.GetRayIntersections(ref Bodies, ref Origins, ref Directions, NumRays, Radius, Offset, out NumIntersections, ref BodyIndex, ref IntersectionPoints, ref IntersectionNormals, ref RayIndex, ref Entity, out Type);
    }
    ...
    {
        _partDocument.MeasureDistance(Element1, Element2, DistanceType, out Distance, out DX, out DY, out DZ, ref Point1, ref Point2);
    }
    ...
    {
        _partDocument.InquireElement(Element, ref InPoint, CoordinateSystem, ref Point, out SurfaceArea, out Volume, out Length);
    }
    ...
    {
        _partDocument.Get3dPrintInfo(out iNumberOfTriangles, out iNumberOfPoints, out iNumberOfEdges, out dMeshSurfaceArea, out dMeshVolume, out dFileSize, out dExportToleranceValue, out dSurfacePlaneAngTol, Type);
    }
