...
public class SheetMetalDocumentAdapter : IPartMetalDocument
{
    ...
    public void PrintOut(object Printer = null, object NumCopies = null, object Orientation = null, object PaperSize = null,
    ...
    {
        _sheetMetalDocument.PrintOut(Printer, NumCopies, Orientation, PaperSize, Scale, PrintToFile, OutputFileName, PrintRange, Sheets, ColorAsBlack, Collate);
    }
    ...
    public void SaveAs(string NewName, object IsATemplate = null, object FileFormat = null, object ReadOnlyEnforced = null,
    ...
    {
        _sheetMetalDocument.SaveAs(NewName, IsATemplate, FileFormat, ReadOnlyEnforced, ReadOnlyRecommended, NewStatus, CreateBackup, UpdateLinkInContainer, UpdateAllLinksInContainer);
    }
    ...
    public string SaveAsWithCustomPropertiesBIDM(string FilePath, string DocumentNumber, string Revision, string Title,
        object varPropInfo)
    {
        return _sheetMetalDocument.SaveAsWithCustomPropertiesBIDM(FilePath, DocumentNumber, Revision, Title, varPropInfo);
    }
    ...
    public void MinimumDistance(object Element1, object Element2, out double Distance, ref Array Point1, ref Array Point2)
    {
    ...
    {
        _sheetMetalDocument.NormalDistance(Element1, Element2, out TrueDistance, out ApparentDistance, out DeltaX, out DeltaY, out DeltaZ, CoordinateSystem);
    }
    ...
    public void GetUserPhysicalProperties(out double Volume, out double Area, out double Mass, out Array CenterOfGravity,
    ...
    {
        _sheetMetalDocument.GetUserPhysicalProperties(out Volume, out Area, out Mass, out CenterOfGravity, out CenterOfVolume, out GlobalMomentsOfInertia, out PrincipalMomentsOfInertia, out PrincipalAxes, out RadiiOfGyration);
    }

    public void PutUserPhysicalProperties(ref double Volume, ref double Area, ref double Mass, ref Array CenterOfGravity,
    ...
    {
        _sheetMetalDocument.PutUserPhysicalProperties(ref Volume, ref Area, ref Mass, ref CenterOfGravity, ref CenterOfVolume, ref GlobalMomentsOfInertia, ref PrincipalMomentsOfInertia, ref PrincipalAxes, ref RadiiOfGyration);
    }
    ...
    public MeasureVariable AddMeasureVariable(MeasureVariableTypeConstants Type, MeasureVariableValueConstants ValueType,
    ...
    public void GetCapturedRelationshipInformation(out Array RelationshipTypes, out Array OffsetTypes, out Array Offsets,
        out object Faces)
    {
        _sheetMetalDocument.GetCapturedRelationshipInformation(out RelationshipTypes, out OffsetTypes, out Offsets, out Faces);
    }
    ...
    public void GoalSeek(string NameTargetVariable, string NameVariableToChange, double dTargetValue, double dTimeLimitInSecs,
    ...
    {
        _sheetMetalDocument.GoalSeek(NameTargetVariable, NameVariableToChange, dTargetValue, dTimeLimitInSecs, NumIterationsLimit, out dTimeElapsed, out NumIterations, out TimeLimitExceeded, out IterationsLimitExceeded);
    }
    ...
    public void PMI_ByModelState(out PMI PMIObj, PMIModelStateConstants PMIModelState = (PMIModelStateConstants)0)
    {
    ...
    {
        _sheetMetalDocument.MoveToSynchronous(pFeatureUnk, bIgnoreWarnings, bExtendSelection, out NumberOfFeaturesCausingError, out ErrorMessageArray, out NumberOfFeaturesCausingWarning, out WarningMessageArray);
    }
    ...
    public void TransformToSynchronousSheetmetal(object pRefFace, int nEdgeNum, ref Array EdgesArray,
        object BRType = null, double dBRWidth = 0, double dBRLength = 0, double dBendRadius = 0, double dNeutralFactor = 0)
    {
        _sheetMetalDocument.TransformToSynchronousSheetmetal(pRefFace, nEdgeNum, ref EdgesArray, BRType, dBRWidth, dBRLength, dBendRadius, dNeutralFactor);
    }
    ...
    {
        _sheetMetalDocument.GetMultiBodyPublishMembers(out NumMembers, out Members, out AssemblyExist, out AssemblyFileName, out AssemblyStatus);
    }
    ...
    {
        _sheetMetalDocument.SaveMultiBodyPublishMembers(NumMembers, ref Members, CreateAssembly, FileName, out AssemblyStatus);
    }
    ...
    public void MeasureDistance(object Element1, object Element2, MeasureDistanceTypeConstants DistanceType, out double Distance,
        out double DX, out double DY, out double DZ, ref Array Point1, ref Array Point2)
    {
        _sheetMetalDocument.MeasureDistance(Element1, Element2, DistanceType, out Distance, out DX, out DY, out DZ, ref Point1, ref Point2);
    }
    ...
    {
        _sheetMetalDocument.MeasureAngleEx(Element1, Element2, Element3, out Angle1, out Angle2, out Angle3, out Angle4);
    }

    public void InquireElement(object Element, ref Array InPoint, object CoordinateSystem, ref Array Point, out double SurfaceArea,
        out double Volume, out double Length)
    {
        _sheetMetalDocument.InquireElement(Element, ref InPoint, CoordinateSystem, ref Point, out SurfaceArea, out Volume, out Length);
    }
    ...
    public void Get3dPrintInfo(out int iNumberOfTriangles, out int iNumberOfPoints, out int iNumberOfEdges,
        ...
        out double dSurfacePlaneAngTol, Print3DFileType Type = (Print3DFileType)0)
    {
        _sheetMetalDocument.Get3dPrintInfo(out iNumberOfTriangles, out iNumberOfPoints, out iNumberOfEdges, out dMeshSurfaceArea, out dMeshVolume, out dFileSize, out dExportToleranceValue, out dSurfacePlaneAngTol, Type);
    }
    ...
    public SheetMetalSensors Sensors => _sheetMetalDocument.Sensors;
