...
public static class ApplicationExtensions
{
    ...
    public static BackgroundOptions GetBackgroundOptions(this Application app)
    {
        ...
        var backgroundOptions = BackgroundOptions.None;
    ...
    /// <summary>
    ///     Returns a bitmask representing the boolean values that represent various background options of the application
    ///     object.
    /// </summary>
    /// <param name="app">The Solid Edge application object.</param>
