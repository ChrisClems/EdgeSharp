...
public static class DocumentExtensions
{
    ...
    /// <returns>A nested dictionary of the properties. The outer dictionary contains the property set names as keys, and the inner dictionaries contain the property names and values.</returns>
    public static Dictionary<string, Dictionary<string, string?>> PropertySetsToDictionary(this SolidEdgeDocument doc, Dictionary<string, string>? extendedProps = null)
    {
